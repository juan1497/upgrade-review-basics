...
// por los usuarios a favorito. Para ello recorre la lista de usuarios y usa forin para recoger el nombre 
...
for (sound of sounds){
    ...
    if(!arrFinal.includes(sound)){
        arrFinal.push(sound,cont)
    }
    cont=0;
}
